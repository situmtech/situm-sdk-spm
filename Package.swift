...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SitumSDK",
            url: "https://repo.situm.es:443/artifactory/libs-release-local/iOS/SitumSDK/3.28.0/SitumSDK.xcframework.zip",
            checksum: "0d8f095dfe57fc5449521ac04948e873b69d1434da2fba0d2accaf95b11ebe4f"
        ),
        .target(
             name: "SitumSDKTarget",

...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SitumSDK",
            url: "https://repo.situm.com:443/artifactory/libs-release-local/iOS/SitumSDK/3.37.2/SitumSDK.xcframework.zip",
            checksum: "af6ec6c4e84f61609b9e651e02734078b61f054cdf0df64b4afd7892f9418f8f"
        ),
        .target(
             name: "SitumSDKTarget",

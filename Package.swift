...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SitumSDK",
            url: "https://repo.situm.com:443/artifactory/libs-release-local/iOS/SitumSDK/3.30.0-support/SitumSDK.xcframework.zip",
            checksum: "265bc5656eb834beeb19dac4dcb34aac5b48a3dd1867639e5b5529fb65fb83a1"
        ),
        .target(
             name: "SitumSDKTarget",

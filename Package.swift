...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SitumSDK",
            url: "https://repo.situm.com:443/artifactory/libs-release-local/iOS/SitumSDK/3.39.0/SitumSDK.xcframework.zip",
            checksum: "f1a340586a3b2582348b4d593fe23ac362032570e53d13ef84157a8e92af99e0"
        ),
        .target(
             name: "SitumSDKTarget",

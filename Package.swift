...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SitumSDK",
            url: "https://repo.situm.es:443/artifactory/libs-release-local/iOS/SitumSDK/3.27.1/SitumSDK.xcframework.zip",
            checksum: "608565f85a87d6df17ab49fe2e241c6982a2f878acc6c4093ce986bada772925"
        ),
        .target(
             name: "SitumSDKTarget",

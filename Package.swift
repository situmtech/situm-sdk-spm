...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SitumSDK",
            url: "https://repo.situm.com:443/artifactory/libs-release-local/iOS/SitumSDK/3.34.12/SitumSDK.xcframework.zip",
            checksum: "f80a26ad76b49b371c7791997b841aac9415d16142e5701d84667d1e34cc7032"
        ),
        .target(
             name: "SitumSDKTarget",
